...
import (
	...
	wrappers "github.com/monk07-01/peggo1.14/solidity/wrappers/PeggySubgraph.sol"
)
		...
		_ = Context("Peggy contract deployment and initialization done", func() {
			...
			_ = Describe("Check contract state", func() {
				...
				_ = Describe("ValsetUpdatedEvent", func() {
					var (
						valsetUpdatedEvent = wrappers.WrappersValsetUpdatedEvent{}
					)
			...
			_ = Describe("ERC20 token deployment via Peggy", func() {
				var (
					...
					erc20DeployedEvent = wrappers.WrappersERC20DeployedEvent{}
				)
						...
						_ = When("Cosmos -> Ethereum batch being submitted", func() {
							...
							_ = Context("TxBatch submitted successfully", func() {
								...
								_ = Describe("TransactionBatchExecutedEvent", func() {
									var (
										transactionBatchExecutedEvent = wrappers.WrappersTransactionBatchExecutedEvent{}
									)
...
func unpackERC20DeployedEventTo(result *wrappers.WrappersERC20DeployedEvent) deployer.ContractLogUnpackFunc {
...
func unpackValsetUpdatedEventTo(result *wrappers.WrappersValsetUpdatedEvent) deployer.ContractLogUnpackFunc {
	return func(unpacker deployer.LogUnpacker, event abi.Event, log ctypes.Log) (interface{}, error) {
		err := unpacker.UnpackLog(result, event.Name, log)
		return &result, err
	}
...
func unpackTransactionBatchExecutedEventTo(result *wrappers.WrappersTransactionBatchExecutedEvent) deployer.ContractLogUnpackFunc {
	return func(unpacker deployer.LogUnpacker, event abi.Event, log ctypes.Log) (interface{}, error) {
		err := unpacker.UnpackLog(result, event.Name, log)
		return &result, err
	}
