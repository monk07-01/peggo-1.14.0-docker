    ...
    ReentrancyGuard
{
    ...
    mapping(address => bool) public isBfhdexNativeToken;

    // TransactionBatchExecutedEvent and SendToBfhdexEvent both include the field _eventNonce.
        ...
        // CHECKS scoped to reduce stack depth
        {
...

            {
                ...
                for (uint256 i = 0; i < _amounts.length; i++) {
                    if (isBfhdexNativeToken[_tokenContract]) {
    ...
    function deployERC20(
        ...
        isBfhdexNativeToken[address(erc20)] = true;
