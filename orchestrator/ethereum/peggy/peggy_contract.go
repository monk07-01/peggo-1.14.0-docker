...
import (
	...
	wrappers "github.com/monk07-01/peggo1.14/solidity/wrappers/Peggy.sol"
	wrappers2 "github.com/monk07-01/peggo1.14/solidity/wrappers/TestERC20.sol"
	// wrappers3 "github.com/monk07-01/peggo1.14/solidity/wrappers/PeggySubgraph.sol"
)
...
func NewPeggyContract(
	...
	ethPeggy, err := wrappers.NewWrappers(peggyAddress, ethCommitter.Provider())
	if err != nil {
		return nil, err
	}
...
var (
	peggyABI, _ = abi.JSON(strings.NewReader(wrappers.WrappersABI))
	erc20ABI, _ = abi.JSON(strings.NewReader(wrappers2.ERC20ABI))
)
