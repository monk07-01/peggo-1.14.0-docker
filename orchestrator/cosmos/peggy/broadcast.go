...
import (
	...
	"github.com/monk07-01/peggo1.14/orchestrator/ethereum/keystore"
	...
	// peggyevents2 "github.com/monk07-01/peggo1.14/solidity/wrappers/TestERC20.sol"
	peggyevents3 "github.com/monk07-01/peggo1.14/solidity/wrappers/PeggySubgraph.sol"
	// "github.com/monk07-01/peggo1.14/solidity/wrappers/PeggySubgraph.sol"
)
...
type BroadcastClient interface {
	...
	SendOldDepositClaim(ctx context.Context, deposit *peggyevents3.WrappersSendToCosmosEvent) error
	SendDepositClaim(ctx context.Context, deposit *peggyevents.WrappersSendToBfhdexEvent) error
	SendWithdrawalClaim(ctx context.Context, withdrawal *peggyevents3.WrappersTransactionBatchExecutedEvent) error
	SendValsetClaim(ctx context.Context, vs *peggyevents3.WrappersValsetUpdatedEvent) error
	SendERC20DeployedClaim(ctx context.Context, erc20 *peggyevents.WrappersERC20DeployedEvent) error
}
...
func (c broadcastClient) SendOldDepositClaim(_ context.Context, deposit *peggyevents3.WrappersSendToCosmosEvent) error {
...
func (c broadcastClient) SendDepositClaim(_ context.Context, deposit *peggyevents.WrappersSendToBfhdexEvent) error {
	// EthereumBridgeDepositClaim
	// When more than 66% of the active validator set has
	// claimed to have seen the deposit enter the ethereum blockchain coins are
	// issued to the Cosmos address in question
	...
	}).Debugln("observed SendToBfhdexEvent")
...
func (c broadcastClient) SendWithdrawalClaim(_ context.Context, withdrawal *peggyevents3.WrappersTransactionBatchExecutedEvent) error {
	metrics.ReportFuncCall(c.svcTags)
	doneFn := metrics.ReportFuncTiming(c.svcTags)
	defer doneFn()
...
func (c broadcastClient) SendValsetClaim(_ context.Context, vs *peggyevents3.WrappersValsetUpdatedEvent) error {
	metrics.ReportFuncCall(c.svcTags)
	doneFn := metrics.ReportFuncTiming(c.svcTags)
	defer doneFn()
...
func (c broadcastClient) SendERC20DeployedClaim(_ context.Context, erc20 *peggyevents.WrappersERC20DeployedEvent) error {
	metrics.ReportFuncCall(c.svcTags)
	doneFn := metrics.ReportFuncTiming(c.svcTags)
	defer doneFn()
