...
type MockCosmosNetwork struct {
	...
	SendOldDepositClaimFn              func(ctx context.Context, deposit *peggyevents2.WrappersSendToCosmosEvent) error
	SendDepositClaimFn                 func(ctx context.Context, deposit *peggyevents2.WrappersSendToBfhdexEvent) error
	SendWithdrawalClaimFn              func(ctx context.Context, withdrawal *peggyevents.WrappersTransactionBatchExecutedEvent) error
	SendValsetClaimFn                  func(ctx context.Context, vs *peggyevents.WrappersValsetUpdatedEvent) error
	SendERC20DeployedClaimFn           func(ctx context.Context, erc20 *peggyevents.WrappersERC20DeployedEvent) error
...
func (n MockCosmosNetwork) SendOldDepositClaim(ctx context.Context, deposit *peggyevents2.WrappersSendToCosmosEvent) error {
	return n.SendOldDepositClaimFn(ctx, deposit)
}

func (n MockCosmosNetwork) SendDepositClaim(ctx context.Context, deposit *peggyevents2.WrappersSendToBfhdexEvent) error {
	return n.SendDepositClaimFn(ctx, deposit)
}

func (n MockCosmosNetwork) SendWithdrawalClaim(ctx context.Context, withdrawal *peggyevents.WrappersTransactionBatchExecutedEvent) error {
	return n.SendWithdrawalClaimFn(ctx, withdrawal)
}

func (n MockCosmosNetwork) SendValsetClaim(ctx context.Context, vs *peggyevents.WrappersValsetUpdatedEvent) error {
	return n.SendValsetClaimFn(ctx, vs)
}

func (n MockCosmosNetwork) SendERC20DeployedClaim(ctx context.Context, erc20 *peggyevents.WrappersERC20DeployedEvent) error {
...
type MockEthereumNetwork struct {
	...
	GetSendToCosmosEventsFn             func(startBlock, endBlock uint64) ([]*peggyevents2.WrappersSendToCosmosEvent, error)
	GetSendToBfhdexEventsFn          func(startBlock, endBlock uint64) ([]*peggyevents2.WrappersSendToBfhdexEvent, error)
	GetPeggyERC20DeployedEventsFn       func(startBlock, endBlock uint64) ([]*peggyevents.WrappersERC20DeployedEvent, error)
	GetValsetUpdatedEventsFn            func(startBlock, endBlock uint64) ([]*peggyevents.WrappersValsetUpdatedEvent, error)
	GetTransactionBatchExecutedEventsFn func(startBlock, endBlock uint64) ([]*peggyevents.WrappersTransactionBatchExecutedEvent, error)
...
func (n MockEthereumNetwork) GetSendToCosmosEvents(startBlock, endBlock uint64) ([]*peggyevents2.WrappersSendToCosmosEvent, error) {
	return n.GetSendToCosmosEventsFn(startBlock, endBlock)
}

func (n MockEthereumNetwork) GetSendToBfhdexEvents(startBlock, endBlock uint64) ([]*peggyevents2.WrappersSendToBfhdexEvent, error) {
	return n.GetSendToBfhdexEventsFn(startBlock, endBlock)
}

func (n MockEthereumNetwork) GetPeggyERC20DeployedEvents(startBlock, endBlock uint64) ([]*peggyevents.WrappersERC20DeployedEvent, error) {
	return n.GetPeggyERC20DeployedEventsFn(startBlock, endBlock)
}

func (n MockEthereumNetwork) GetValsetUpdatedEvents(startBlock, endBlock uint64) ([]*peggyevents.WrappersValsetUpdatedEvent, error) {
	return n.GetValsetUpdatedEventsFn(startBlock, endBlock)
}

func (n MockEthereumNetwork) GetTransactionBatchExecutedEvents(startBlock, endBlock uint64) ([]*peggyevents.WrappersTransactionBatchExecutedEvent, error) {
